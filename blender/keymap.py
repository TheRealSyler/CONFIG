...
[("Window",
  ...
  {"items":
   [("sop.sm_main_popup",
    ...
    ("sop.sm_mt_pie_workspaces_menu_call", {"type": 'W', "value": 'PRESS', "ctrl": True}, None),
    ("sop.sm_mt_pie_w_menu_call", {"type": 'W', "value": 'PRESS'}, None),
    ("wm.call_menu_pie",
 ...
 ("Object Mode",
  {"space_type": 'EMPTY', "region_type": 'WINDOW'},
  {"items":
   [("sop.sm_mt_pie_a_menu_call", {"type": 'A', "value": 'PRESS'}, None),
    ("sop.sm_mt_pie_q_menu_call", {"type": 'Q', "value": 'PRESS'}, None),
    ("sop.sm_mt_pie_add_call", {"type": 'A', "value": 'PRESS', "shift": True}, None),
    ("sop.sm_mt_pie_a_menu_call", {"type": 'A', "value": 'PRESS'}, None),
    ("sop.sm_mt_pie_q_menu_call", {"type": 'Q', "value": 'PRESS'}, None),
    ("sop.sm_mt_pie_add_call", {"type": 'A', "value": 'PRESS', "shift": True}, None),
    ("wm.call_menu_pie",
